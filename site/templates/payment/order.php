									...
									<div class="wizard-step flex-grow-1 flex-basis-0" data-wizard-type="step" <?=($var_step==1 ? 'data-wizard-state="current"' : '');?> >
										<div class="wizard-wrapper pr-7">
											...
											<div class="wizard-label">
												...
												<div class="wizard-desc">Заказ: <b>№<?=$var_m_num;?></b></div>
											</div>
									...
									<div class="wizard-step flex-grow-1 flex-basis-0" data-wizard-type="step" <?=($var_step==3 ? 'data-wizard-state="current"' : '');?> >
										<div class="wizard-wrapper">
											...
											<div class="wizard-label">
												...
												<div class="wizard-desc">Текущего заказа</div>
											</div>
										</div>
									</div>
						...
						<div class="login-form">
							...
							<form class="form px-10" novalidate="novalidate" id="step1_form">
								...
								<div data-wizard-type="step-content" <?=($var_step==1 ? 'data-wizard-state="current"' : '');?> >
										...
										<p>Описание заказа: <b><?=$var_order_desc;?></b></p>
										<p>Сумма: <b><?=$var_order_amount;?>$</b></p>
										<hr>
									...
									<button type="button" class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3" onClick="sendOrder()">Далее
								...
								<div class="pb-5" data-wizard-type="step-content" <?=($var_step==3 ? 'data-wizard-state="current"' : '');?> >
									...
									<div class="pt-lg-0 pt-5 pb-15">
										<? if ($var_expired) { ?>
											<h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg"><i class="flaticon2-hourglass-1 icon-2x"></i> Время оплаты истекло</h3>
											<div class="text-muted font-weight-bold font-size-h4">Вы не успели оплатить заказ в отведенное время, создайте новый или обратитесь в поддержку</div>
											<br>
											<h4><a href="<?=$var_m_url_error;?>">Вернуться в магазин</a></h4>
										...
										<? } else if ($var_pay_status == PAY_STATUS_PAYS || $var_pay_status == PAY_STATUS_IN_WORK ) { ?>
											...
											<br>
											<h4><a href="<?=$var_m_url_success;?>">Вернуться в магазин</a></h4>
