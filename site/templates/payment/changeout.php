									...
									<div class="wizard-step flex-grow-1 flex-basis-0" data-wizard-type="step" <?=($var_step==2 ? 'data-wizard-state="current"' : '');?> >
										<div class="wizard-wrapper pr-7">
											...
											<div class="wizard-label">
												...
												<div class="wizard-desc">Заявки <b><?=@$var_pay_id;?></b></div>
											</div>
											<span class="svg-icon pl-6">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						...
						<div class="login-form">
							<!--begin::Form-->
									   ...
									   <div class="row">
										...
										<div class="row" id="props">
											...
											<div class="col-lg-12 pt-5">
												<h2>Email</h2>
												<p><input style="width:300px" type="text" id="email" /></p>
												<h2>Реквизиты зачисления (счет\карта и т.д.)</h2>
												<p><input style="width:300px" type="text" id="props_val" /></p>
											</div>
								...
								<div class="pb-5" data-wizard-type="step-content" <?=($var_step==2 ? 'data-wizard-state="current"' : '');?> >
											...
											<div class="card card-custom card-fit card-border p-10">
												<div class="card-body pt-2 text-center">
													...
													<div class="d-flex align-items-center justify-content-between mb-2 h5">
														...
														<span class="text-hover-primary"><b><?=$var_psd_amount;?></b> <?=$var_from_bal_name;?>
													...
													<div class="d-flex align-items-center justify-content-between mb-2 h5">
														<span class="font-weight-bold mr-2">На реквизиты:</span>
														<span class="text-hover-primary"><b><?=$var_psd_props;?></b>
														</span>
													</div>
									...
									</span>Отменить заявку</button>	

									<button type="button" class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3 float-right" onClick="confirmChange()">Я оплатил
										<span class="svg-icon svg-icon-md ml-2">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Right-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<div class="pb-5" data-wizard-type="step-content" <?=($var_step==3 ? 'data-wizard-state="current"' : '');?> >
									...
									<div class="pt-lg-0 pt-5 pb-15">
										...
										<? } else if ($var_pay_status == PAY_STATUS_PAYS || $var_pay_status == PAY_STATUS_IN_WORK ) { ?>
											...
											<div class="text-muted font-weight-bold font-size-h4">Заявка успешно выполнена! В блиайшее время средства поступят на Ваш счет</div>
