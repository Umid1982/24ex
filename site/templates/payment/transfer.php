									...
									<div class="wizard-step flex-grow-1 flex-basis-0" data-wizard-type="step" <?=($var_step==1 ? 'data-wizard-state="current"' : '');?> >
										<div class="wizard-wrapper pr-7">
											...
											<div class="wizard-label">
												<h3 class="wizard-title">Перевод</h3>
									...
									<div class="wizard-step flex-grow-1 flex-basis-0" data-wizard-type="step" <?=($var_step==2 ? 'data-wizard-state="current"' : '');?> >
										<div class="wizard-wrapper pr-7">
											...
											<div class="wizard-label">
												...
												<div class="wizard-desc">Реквизитов</div>
											</div>
											<span class="svg-icon pl-6">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						...
						<div class="login-form">
							<!--begin::Form-->
								...
								<form id="step1_form">
									...
									<div class="card card-custom card-fit card-border p-10">
										<div class="card-body pt-2 text-center">
											...
											<div class="d-flex align-items-center justify-content-between mb-2 h5">
												<span class="font-weight-bold mr-2">Номер кошелька получателя:</span>
												<span class="text-hover-primary">
													<input type="text" name="user_bal_num" class="form-control" style="width:300px;" />
												</span>
											</div>
											...
											<div class="d-flex align-items-center justify-content-between mb-2 h5">
												...
												<span class="text-hover-primary"><b><?=$var_pay_value;?></b> <?=$var_bal_name;?></span>
											</div>

											<br>

											<div class="d-flex align-items-center justify-content-between mb-2 h5">
												<span class="font-weight-bold mr-2">Комиссия за перевод:</span>
												<span class="text-hover-primary"><b><?=$var_pay_com;?></b> <?=$var_bal_name;?></span>
											</div>
						  				...
						  				<? if ($var_need_paypass) { ?>
											...
											<div class="d-flex align-items-center justify-content-between mb-2 h5">
												<span class="font-weight-bold mr-2">Введите пллатежный пароль:</span>
												<span class="text-hover-primary">
													<input type="text" name="pay_pass" class="form-control" style="width:300px;" />
												</span>
											</div>
										<? } else { ?>
									...
									<button type="button" class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3" onClick="sendTransferData()">Далее
								...
								<div class="pb-5" data-wizard-type="step-content" <?=($var_step==2 ? 'data-wizard-state="current"' : '');?> >
									...
									<div class="bg-white rounded">
										...
										<div class="card card-custom card-fit card-border p-10">
											...
											<div class="d-flex align-items-center justify-content-between mb-2 h5">
												<span class="font-weight-bold mr-2">Номер кошелька получателя:</span>
												<span class="text-hover-primary"><b><?=$var_user_bal_num;?></b></span>
											</div>
											...
											<div class="d-flex align-items-center justify-content-between mb-2 h5">
												<span class="font-weight-bold mr-2">Комиссия за конверсию:</span>
												<span class="text-hover-primary"><b><?=$var_change_com;?></b> <?=$var_bal_name;?></span>
											</div>

											<br>

											<div class="d-flex align-items-center justify-content-between mb-2 h5">
												<span class="font-weight-bold mr-2">Сумма к получению:</span>
												<span class="text-hover-primary"><b><?=$var_change_val;?></b> <?=$var_change_bal_name;?></span>
											</div>
									...
									<div>
									<button type="button" class="btn btn-primary font-weight-bolder font-size-h6 pr-4 py-4 my-3 float-left" onClick="resetTransferProps(<?=$var_pay_id;?>)">
										<span class="svg-icon svg-icon-md ml-2">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										        <polygon points="0 0 24 0 24 24 0 24"/>
									...
									<button type="button" class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3 float-right" onClick="confirmTransfer(<?=$var_pay_id;?>)">Подтвердить
										<span class="svg-icon svg-icon-md ml-2">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Right-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<div class="pb-5" data-wizard-type="step-content" <?=($var_step==3 ? 'data-wizard-state="current"' : '');?> >
									...
									<div class="pt-lg-0 pt-5 pb-15">
										...
										<? } else if ($var_pay_status == PAY_STATUS_PAYS || $var_pay_status == PAY_STATUS_IN_WORK ) { ?>
											...
											<div class="text-muted font-weight-bold font-size-h4">Перевод успешно выполнен! В ближайшее время средства поступят на счет получателя</div>
										<? } else if ($var_pay_status == PAY_STATUS_DONE) { ?>
											<h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg"><i class="flaticon-like icon-2x text-success"></i> Успешно</h3>
											<div class="text-muted font-weight-bold font-size-h4">Перевод успешно обработан, средства зачислены на счет получателя</div>											
										<? } ?>
										<h3><a href="/<?=_LANG_;?>/office/bals">Вернусть к балансам</a></h3>
									</div>
